...
/* AnyGM modification: use the same bounded decoder-only configuration in all
 * translation units. See README.anygm.md. */
#include "anygm_config.h"

#ifndef _POSIX_SOURCE /* AnyGM: respect the embedding translation unit. */
