...
GmlVal builtin_call_impl(GmlVM *vm, const char *nm, GmlVal *a, int n){
  ...
  GmlVal external_result=builtin_external_call_encoded(
...
GmlVal gml_builtin_try_platform_tail(GmlVM *vm, const char *nm, GmlVal *a, int n){
  ...
  if(!strcmp(nm,"gpu_set_alphatestenable")||!strcmp(nm,"draw_set_alpha_test")){ GmlRender *R2=(GmlRender*)vm->render;
