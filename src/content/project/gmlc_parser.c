...
static int resolve_const(Compiler *c, const char *name, double *out){
  ...
  static const struct { const char *name; int value; } event_constants[]={
    ...
    {"ev_draw_normal",0},
    {"ev_left_button",0}, {"ev_right_button",1}, {"ev_middle_button",2},
    {"ev_no_button",3},
    ...
    {"ev_global_left_button",50}, {"ev_global_right_button",51},
    {"ev_global_middle_button",52},
    {"ev_global_left_press",53}, {"ev_global_right_press",54},
    {"ev_global_middle_press",55},
    {"ev_global_left_release",56}, {"ev_global_right_release",57},
